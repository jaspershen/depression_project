...
depression_association_pos = 
  try(
    readr::read_table(file = "results_0328_lipid/depression/lipid_depression_association_pos.txt")
    ,silent = TRUE
  )
...
depression_association_neg = 
  try( readr::read_table(file = "results_0328_lipid/depression/lipid_depression_association_neg.txt"),
       silent = TRUE)
...
depression_slope_up = 
  try(readr::read_table(file = "results_0328_lipid/depression/lipid_depression_slope_up.txt"), 
      silent = TRUE)
...
depression_slope_down = 
  try(readr::read_table(file = "results_0328_lipid/depression/lipid_depression_slope_down.txt"), 
      silent = TRUE)
...
safety_association_pos = 
  try(
    readr::read_table(file = "results_0328_lipid/safety/lipid_safety_association_pos.txt")
    ,silent = TRUE
  )
...
if(class(safety_association_pos)[1] == "try-error"){
  ...
  safety_association_pos$Variables =
    safety_association_pos$X1
  safety_association_pos = 
...
safety_association_neg = 
  try( readr::read_table(file = "results_0328_lipid/safety/lipid_safety_association_neg.txt"),
       silent = TRUE)

if(class(safety_association_neg)[1] == "try-error"){
  safety_association_neg = NULL
}else{
  safety_association_neg$Variables = 
    safety_association_neg$X1
  safety_association_neg = 
    safety_association_neg[,-1]
}

safety_slope_up = 
  try(readr::read_table(file = "results_0328_lipid/safety/lipid_safety_slope_up.txt"), 
      silent = TRUE)
...
safety_slope_down = 
  try(readr::read_table(file = "results_0328_lipid/safety/lipid_safety_slope_down.txt"), 
      silent = TRUE)
