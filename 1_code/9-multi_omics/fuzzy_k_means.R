...
###cytokine
load("3_data_analysis/Cytokines/data_preparation/expression_data")
load("3_data_analysis/Cytokines/data_preparation/sample_info")
load("3_data_analysis/Cytokines/data_preparation/variable_info")

load("3_data_analysis/Cytokines/marker/depression_association_pos")
load("3_data_analysis/Cytokines/marker/depression_association_neg")
...
###lipid
load("3_data_analysis/Lipids/data_preparation/expression_data")
load("3_data_analysis/Lipids/data_preparation/sample_info")
load("3_data_analysis/Lipids/data_preparation/variable_info")

load("3_data_analysis/Lipids/marker/depression_association_pos")
load("3_data_analysis/Lipids/marker/depression_association_neg")
...
###metabolic_panel
load("3_data_analysis/Metabolic_Panel/data_preparation/expression_data")
load("3_data_analysis/Metabolic_Panel/data_preparation/sample_info")
load("3_data_analysis/Metabolic_Panel/data_preparation/variable_info")

load("3_data_analysis/Metabolic_Panel/marker/depression_association_pos")
load("3_data_analysis/Metabolic_Panel/marker/depression_association_neg")
...
###metabolomics
load(
  "3_data_analysis/metabolomics_data/data_preparation/metabolites/expression_data"
)
load("3_data_analysis/metabolomics_data/data_preparation/metabolites/sample_info")
load("3_data_analysis/metabolomics_data/data_preparation/metabolites/variable_info")

load("3_data_analysis/metabolomics_data/marker/depression_association_pos")
load("3_data_analysis/metabolomics_data/marker/depression_association_neg")
...
setwd(r4projects::get_project_wd())
setwd("3_data_analysis/multi_omics/k_means/")
...
tp <- sort(unique(sample_info$Time))

temp_data_mean <-
  purrr::map(tp, function(x) {
    temp_idx <- which(sample_info$Time == x)
    temp_data[, temp_idx] %>%
      apply(1, mean)
  }) %>%
  do.call(cbind, .) %>%
