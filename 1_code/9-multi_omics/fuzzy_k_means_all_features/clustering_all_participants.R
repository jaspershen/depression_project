...
###metabolomics
load("3_data_analysis/metabolomics_data/data_preparation/metabolites/expression_data")
...
setwd(r4projects::get_project_wd())
dir.create("3_data_analysis/multi_omics_all_features/all_participant/",
           recursive = TRUE)
setwd("3_data_analysis/multi_omics_all_features/all_participant/")
