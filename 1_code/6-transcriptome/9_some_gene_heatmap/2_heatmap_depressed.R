...
dir.create("3_data_analysis/transcriptomics/heatmap_for_some_genes/all_depressed",
           recursive = TRUE)
setwd("3_data_analysis/transcriptomics/heatmap_for_some_genes/all_depressed")
