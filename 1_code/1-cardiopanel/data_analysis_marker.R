...
setwd("3_data_analysis/Cardiovascular_Risk_Panel/")
...
depression_association_pos = 
  try(
    readr::read_table(file = "results_0108_cardio/depression/cardio_depression_association_pos.txt")
    ,silent = TRUE
  )
...
depression_association_neg = 
  try( readr::read_table(file = "results_0108_cardio/depression/cardio_depression_association_neg.txt"),
       silent = TRUE)
...
depression_slope_up = 
  try(readr::read_table(file = "results_0108_cardio/depression/cardio_depression_slope_up.txt"), 
      silent = TRUE)
...
depression_slope_down = 
  try(readr::read_table(file = "results_0108_cardio/depression/cardio_depression_slope_down.txt"), 
      silent = TRUE)
...
safety_association_pos = 
  try(
    readr::read_table(file = "results_0108_cardio/safety/cardio_safety_association_pos.txt")
    ,silent = TRUE
  )
...
safety_association_neg = 
  try( readr::read_table(file = "results_0108_cardio/safety/cardio_safety_association_neg.txt"),
       silent = TRUE)
...
safety_slope_up = 
  try(readr::read_table(file = "results_0108_cardio/safety/cardio_safety_slope_up.txt"), 
      silent = TRUE)
...
safety_slope_down = 
  try(readr::read_table(file = "results_0108_cardio/safety/cardio_safety_slope_down.txt"), 
      silent = TRUE)
...
depression_association_pos$Variables = variable_info$variable_id[c(3,1)]

safety_slope_down$Gene = variable_info$variable_id[c(2)]
