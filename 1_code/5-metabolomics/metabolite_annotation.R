...
# setwd("3_data_analysis/metabolomics_data/MSMS Annotation/RPLC pos/")
# library(tidyverse)
# library(data.table)
# library(metID)
# 
...
# ###negative mode
# setwd(r4projects::get_project_wd())
# setwd("3_data_analysis/metabolomics_data/MSMS Annotation/RPLC neg/")
# library(tidyverse)
# library(data.table)
# library(metID)
# 
...
# ###positive mode
# setwd(r4projects::get_project_wd())
# setwd("3_data_analysis/metabolomics_data/MSMS Annotation/HILIC pos/")
# library(tidyverse)
# library(data.table)
# library(metID)
# 
...
# ###negative mode
# setwd(r4projects::get_project_wd())
# setwd("3_data_analysis/metabolomics_data/MSMS Annotation/HILIC neg/")
# library(tidyverse)
# library(data.table)
# library(metID)
# 
...
setwd(r4projects::get_project_wd())
setwd("3_data_analysis/metabolomics_data/MSMS Annotation/")
