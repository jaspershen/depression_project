...
load("3_data_analysis/metabolomics_data/data_preparation/expression_data")
load("3_data_analysis/metabolomics_data/data_preparation/sample_info")
load("3_data_analysis/metabolomics_data/data_preparation/variable_info")

dir.create("3_data_analysis/metabolomics_data/Pathway Analysis/")
setwd("3_data_analysis/metabolomics_data/Pathway Analysis/")
...
edge_data <-
  edge_data %>%
  dplyr::select(from = pathway, to = variable_id) %>%
...
plot1 <-
  ...
  geom_node_point(
    aes(fill = path_name, size = Degree),
    shape = 21,
    alpha = 1,
    show.legend = FALSE
  ) +
